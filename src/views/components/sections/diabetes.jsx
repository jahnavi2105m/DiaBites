...
import banner from '../../../assets/images/form-banners/banner1/chart.png';


const Diabetes = () => {
    return (
        <div>
            <div className="spacer mb-3" id="label-component">
                        ...
                        <Container>
                            <Row>
                                ...
                                <Col lg={{ size: 6, offset: 6 }} md={{ size: 7, offset: 5 }} className="align-self-center ms-auto">
